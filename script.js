...
function getWeatherData(e) {
    ...
    if(cityName) 
    {
            ...
            .then((data) => {
                //console.log(data);
                //image
                document.querySelector('.img1').src = `https://openweathermap.org/img/wn/${data.weather[0].icon}@2x.png`;
                //data
            ...
            .then((data) => {
                ...
                //9am
                document.querySelector('.img2').src = `https://openweathermap.org/img/wn/${data.list[0].weather[0].icon}@2x.png`;
                ...
                //12pm
                document.querySelector('.img3').src = `https://openweathermap.org/img/wn/${data.list[1].weather[0].icon}@2x.png`;
                ...
                //3pm
                document.querySelector('.img4').src = `https://openweathermap.org/img/wn/${data.list[2].weather[0].icon}@2x.png`;
                ...
                //6pm
                document.querySelector('.img5').src = `https://openweathermap.org/img/wn/${data.list[3].weather[0].icon}@2x.png`;
                ...
                //9pm
                document.querySelector('.img6').src = `https://openweathermap.org/img/wn/${data.list[4].weather[0].icon}@2x.png`;
